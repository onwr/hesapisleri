...
type InvoicesTableControlsProps = {
...
const tabKeys = Object.keys(INVOICE_TAB_LABELS) as InvoiceTabKey[];
...
export function InvoicesTableToolbar({
  ...
  to,
  searchQuery,
}: Pick<InvoicesTableControlsProps, "activeTab" | "from" | "to" | "searchQuery">) {
  ...
  return (
    <div className="flex flex-col gap-3 border-b border-slate-100 p-4">
      ...
      >
        ...
        <Link
          href="/invoices/new"
          className="flex h-10 items-center justify-center gap-2 rounded-xl bg-linear-to-br from-blue-600 to-violet-600 px-5 text-[12px] font-black text-white shadow-lg shadow-blue-100 transition hover:opacity-95"
        >
