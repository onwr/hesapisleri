  ...
  return (
    <div className="rounded-2xl border border-slate-200/80 bg-white p-4 shadow-[0_10px_28px_rgba(15,23,42,0.04)]">
      <div className="mb-3 flex items-center justify-between gap-2">
        ...
        {data.isStale ? (
          <span className="rounded-md bg-amber-50 px-2 py-1 text-[13px] font-black text-amber-800">
            Son alınan kur
          </span>
        ) : null}
      </div>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between gap-3">
          <span className="text-[13px] font-bold text-slate-600">USD</span>
          <span className="text-[14px] font-extrabold text-[#0f1f4d]">
            {formatMoney(data.rates.USD)}
          </span>
        </div>
        <div className="flex items-center justify-between gap-3">
          <span className="text-[13px] font-bold text-slate-600">EUR</span>
          <span className="text-[14px] font-extrabold text-[#0f1f4d]">
            {formatMoney(data.rates.EUR)}
          </span>
        </div>
        <div className="flex items-center justify-between gap-3">
          <span className="text-[13px] font-bold text-slate-600">GBP</span>
          <span className="text-[14px] font-extrabold text-[#0f1f4d]">
