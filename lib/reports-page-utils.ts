...
export const REPORT_CARDS: ReportCardItem[] = [
  {
    key: "income-expense",
    title: "Gelir - Gider",
    description: "Günlük kâr ve gider dağılımı",
    tab: "financial",
    iconKey: "trendingUp",
    color: "emerald",
  },
  {
    key: "cash-flow",
    title: "Kasa & Tahsilat",
    description: "Nakit / kart giriş-çıkışları",
    tab: "financial",
    iconKey: "wallet",
    color: "blue",
  },
  {
    key: "sales",
    title: "Günlük Satış",
    description: "Satış ve tahsilat özeti",
    tab: "sales",
    iconKey: "barChart",
    color: "orange",
  },
  ...
  },
  {
    ...
    description: "Çalışan satış ve verimlilik",
    tab: "all",
